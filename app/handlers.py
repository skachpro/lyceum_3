...
async def select_profile(message: Message):
    await message.reply(f'Вам буде надано анкету яка допоможе обрати профіль, покаже до якого профілю ви більш схильні у відсотковому співвідношенні.',reply_markup=kb.start_chooing_profiles)
